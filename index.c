...
struct MuttWindow *index_pager_init(void)
{
  ...
  struct MuttWindow *cont_right = mutt_window_new(
      WT_CONTAINER, C_DevelIndexWidescreen ? MUTT_WIN_ORIENT_HORIZONTAL : MUTT_WIN_ORIENT_VERTICAL,
      MUTT_WIN_SIZE_MAXIMISE, MUTT_WIN_SIZE_UNLIMITED, MUTT_WIN_SIZE_UNLIMITED);
...
int mutt_dlgindex_observer(struct NotifyCallback *nc)
{
  ...
  if (mutt_str_strcmp(ec->name, "devel_index_widescreen") == 0)
  {
